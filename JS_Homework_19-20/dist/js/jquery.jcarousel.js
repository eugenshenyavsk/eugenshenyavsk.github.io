...
(function ($) {
    ...
    jCarousel.parseTarget = function (target) {
        var relative = false,
            parts = (typeof target === 'undefined' ? 'undefined' : _typeof(target)) !== 'object' ? rRelativeTarget.exec(target) : null;
...
(function ($, window) {
    ...
    $.jCarousel.plugin('jcarousel', {
        ...
        _animate: function _animate(properties, animate, callback) {
            ...
            var opts = (typeof animation === 'undefined' ? 'undefined' : _typeof(animation)) === 'object' ? $.extend({}, animation) : { duration: animation },
